...
function approximateColor(color) {
  ...
  return getAllColors().map(function (currColor) {
    return { color: currColor, distance: colorDistance(color, currColor) };
  }).reduce(function (min, curr) {
    return curr.distance < min.distance ? curr : min;
...
function getColorFamily(color) {
  ...
  return arrayify(_palettes.Palettes).find(function (fam) {
    var family = arrayify(fam);
    if (family.find(function (col) {
      return col === match;
    })) return family;
  });
}
...
function getAllColors() {
  ...
  Object.keys(_palettes.Palettes).forEach(function (palette) {
    Object.keys(_palettes.Palettes[palette]).forEach(function (materialColorWeight) {
      result.push(_palettes.Palettes[palette][materialColorWeight]);
    });
  });
  return result;
}
...
},{"./palettes":4}],3:[function(require,module,exports){
'use strict';
...
},{"materialcolorize":3,"react":160}],163:[function(require,module,exports){
'use strict';
...
},{"./App":161,"es6-shim":1,"react":160}]},{},[164]);
